...
enum NumNameSet{EE,In,C_F,DPSW,HSCI,TURN,BUZ,LOC,ID,AL_H,AL_L,HC_H,HC_L,SO_T,SO_R,ST_T,ST_R,
...
EXT_USER volatile UINT startDelay,trun,comRx,turOff,power,checkOff;//,comTx,comAdr;
EXT_USER volatile u32 stTime;
EXT_USER uint8_t Rxbuf1[20],Txbuf[20],comAddrss,tempId;
EXT_USER uint8_t Versions[4],disp,replan;
EXT_USER uint16_t svDelay;

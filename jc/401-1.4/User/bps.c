...
*/
//ID1-PB4,ID2-PA15,ID3-PB3,ID4-PA10,ID5-PA9,ID6-PB9,ID7-PB5

	                //ID3-PB3,ID1-PB4,ID7-PB5, ID6-PB9
	                //ID5-PA9,ID4-PA10,ID2-PA15
uint8_t getID(void)
{
	union {
	   struct
	...
	adr.bit.ID1 = (GPIOB->IDR & GPIO_Pin_4)? 0:1;  //ID1-PB4
	adr.bit.ID2 = (GPIOA->IDR & GPIO_Pin_15)? 0:1; //ID2-PA15
	adr.bit.ID3 = (GPIOB->IDR & GPIO_Pin_3)? 0:1;  //ID3-PB3  //
	adr.bit.ID4 = (GPIOA->IDR & GPIO_Pin_10)? 0:1; //ID4-PA10 	
	adr.bit.ID5 = (GPIOA->IDR & GPIO_Pin_9)? 0:1;  //ID5-PA9  
	adr.bit.ID6 = (GPIOB->IDR & GPIO_Pin_9)? 0:1;  //ID6-PB9
	adr.bit.ID7 = 0;
...
void GPIO_Configuration(void)
{
	...
	portSet.GPIO_Pin=GPIO_Pin_8|GPIO_Pin_11|GPIO_Pin_12;//
	...
	GPIO_Init(GPIOA,&portSet);
	portSet.GPIO_Pin=GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_15;
	portSet.GPIO_Mode=GPIO_Mode_IPU;
	GPIO_Init(GPIOA,&portSet);

	portSet.GPIO_Pin=GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_12;

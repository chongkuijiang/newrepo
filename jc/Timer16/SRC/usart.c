...
//---------------------------------------------------------------------------------------- 
  ...
  char Rxbuf1[2048];
  uint8_t Txbuf1[2048];
  uint16_t pr1,pt1,rxtim1,txlen1;
...
//---------------------------------------------------------------------------------------- 
  ...
  uint8_t Rxbuf3[100],pr3,rxtim3;
  uint8_t Txbuf3[100],pt3,txlen3;
...
void sendn(USART_TypeDef* mUsart,uint8_t* txbuf,uint16_t* txlen,char* buf){   
	uint16_t i=0;
	while(buf[i]!='\0'){
...
//---------------------------------------------------------
void send(USART_TypeDef* mUsart,uint8_t* txbuf,uint16_t* txlen,uint8_t* buf,uint16_t buflen){   
...
void U1send(uint8_t* buf,uint16_t buflen){

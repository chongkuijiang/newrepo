...
#define  OS_VERSION                 288u                /* Version of uC/OS-II (Vx.yy mult. by 100)    */
...
#if (OS_FLAG_EN > 0) && (OS_FLAG_NAME_EN > 0)
...
#if (OS_EVENT_NAME_EN > 0) || (OS_FLAG_NAME_EN > 0) || (OS_MEM_NAME_EN > 0) || (OS_TASK_NAME_EN > 0)

...
void GetCommID(void)
{
	bit_t adr;
	adr.dat = 0;
	adr.bit.d0 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_15);
	adr.bit.d1 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_14);
	adr.bit.d2 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_13);
	adr.bit.d3 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_12);
	adr.bit.d4 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_11);
	adr.bit.d5 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_10);
	adr.bit.d6 = !GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_9);
   SYS.ID = adr.dat;
}

...
float DataConverter1(int P,int e0,int e1,int sv,int pv)
{
		...
		if(dataBuff<1000) dataBuff1=4240-pow(dataBuff,1.24);
		else dataBuff1=-pow(dataBuff-1000,1.0);
						
		dataBuff1=9000+dataBuff1;
		if(dataBuff1<6000) dataBuff1=6000;
		DataP=dataBuff1*P;
		UdBak1=UdBak0;
    ...
    if(dataBuff1>5000)	dataBuff1=5000;
		...
		dataBuff1=abs(sv-pv);						
		if(sv>pv) result+=(10+pow((float)dataBuff1,0.9))*P/(P+(P+40)/3);
		else if(sv<pv) result+=(-10-pow((float)dataBuff1,0.9))*P/(P+(P+40)/3);		
    if(e1>=e0) result+=(float)(pow((e1-e0),1.2)*DataP)/14000;//***
		else result+=(float)(pow((e0-e1),1.2)*DataP)/-14000;//***		
		return result;
}
float DataConverter2(int P,int e0,int e1,int sv,int pv)
{
    ...
    if(dataBuff1>5000)	dataBuff1=5000;
		...
		result+=dataBuff1*0.75;	*/
		dataBuff1=abs(sv-pv);						
		if(sv>pv) result+=(10+pow((float)dataBuff1,0.90))*P/(P+(P+40)/3);
		else if(sv<pv) result+=(-10-pow((float)dataBuff1,0.90))*P/(P+(P+40)/3);		
    if(e1>=e0) result+=(float)(pow((e1-e0),1.2)*DataP)/14000;//***
		else result+=(float)(pow((e0-e1),1.2)*DataP)/-14000;//***		
		return result;
}

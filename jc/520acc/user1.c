...
void TaskStartPID1(void *yydata)
{
    ...
    outBak=CHdata1.DataGet[Rate];
		...
		sw2 = ACC[0].risSW;
		if((sw1==1)&&(sw2==0)){
			Reg4Data[124]=ACC[0].risTime = CHdata1.DataSet[RisTime];
		}
		sw1 = sw2;		
		onoff2 = CHdata1.DataSet[OnOff];
		...
		if(ACC[0].risSW){	
			if((ACC[0].risTime>0)){
				Reg4Data[124]=ACC[0].risTime--;
				if((CHdata1.DataSet[OnOff])&&(CHdata1.DataGet[Tem_PV]<CHdata1.DataSet[RisTem]*10)) CHdata1.DataGet[Rate] = CHdata1.DataSet[RisRang];	
...
void TaskStartPID2(void *yydata)
{
    ...
    outBak=CHdata2.DataGet[Rate];
		...
		sw2 = ACC[1].risSW;
		if((sw1==1)&&(sw2==0)){
			Reg4Data[125]=ACC[1].risTime = CHdata2.DataSet[RisTime];
		}
		sw1 = sw2;		
		onoff2 = CHdata2.DataSet[OnOff];
		if((onoff1==1)&&(onoff2==0)){
		...
		if(ACC[1].risSW){	
			if((ACC[1].risTime>0)){
				Reg4Data[125]=ACC[1].risTime--;
				if((CHdata2.DataSet[OnOff])&&(CHdata2.DataGet[Tem_PV]<CHdata2.DataSet[RisTem]*10)) CHdata2.DataGet[Rate] = CHdata2.DataSet[RisRang];	
...
void TaskStartPID3(void *yydata)
{
    ...
    outBak=CHdata3.DataGet[Rate];	
		...
		sw2 = ACC[2].risSW;
		if((sw1==1)&&(sw2==0)){
			Reg4Data[126]=ACC[2].risTime = CHdata3.DataSet[RisTime];
		}
		sw1 = sw2;		
		onoff2 = CHdata3.DataSet[OnOff];
		if((onoff1==1)&&(onoff2==0)){
		...
		if(ACC[2].risSW){	
			if((ACC[2].risTime>0)){
				Reg4Data[126]=ACC[2].risTime--;
				if((CHdata3.DataSet[OnOff])&&(CHdata3.DataGet[Tem_PV]<CHdata3.DataSet[RisTem]*10)) CHdata3.DataGet[Rate] = CHdata3.DataSet[RisRang];	
...
//		OSTimeDly(9995);
    ...
    outBak=CHdata4.DataGet[Rate];
		...
		sw2 = ACC[3].risSW;
		if((sw1==1)&&(sw2==0)){
			Reg4Data[127]=ACC[3].risTime = CHdata4.DataSet[RisTime];
		}
		sw1 = sw2;		
		onoff2 = CHdata4.DataSet[OnOff];
		if((onoff1==1)&&(onoff2==0)){
		...
		if(ACC[3].risSW){	
			if((ACC[3].risTime>0)){
				Reg4Data[127]=ACC[3].risTime--;
				if((CHdata4.DataSet[OnOff])&&(CHdata4.DataGet[Tem_PV]<CHdata4.DataSet[RisTem]*10)) CHdata4.DataGet[Rate] = CHdata4.DataSet[RisRang];	

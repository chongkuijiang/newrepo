	...
	while(1)
	{
        ...
        Reg3Data[17]=(s32)Reg4Data[91]*CHdata4.DataGet[Current]/100; 
            ...
            else if(CHdata1.RunningMode==1)
            {
                ...
                else if((CHdata1.AutoFlag==2)||(CHdata1.AutoFlag==4)) Reg3Data[22]=(ACC[0].risSW)? Rise : AUTO;
            ...
            else if(CHdata2.RunningMode==1)
            {
                ...
                else if((CHdata2.AutoFlag==2)||(CHdata2.AutoFlag==4)) Reg3Data[23]=(ACC[1].risSW)? Rise : AUTO;
            ...
            else if(CHdata3.RunningMode==1)
            {
                ...
                else if((CHdata3.AutoFlag==2)||(CHdata3.AutoFlag==4)) Reg3Data[24]=(ACC[2].risSW)? Rise : AUTO;
            ...
            else if(CHdata4.RunningMode==1)
            {
                ...
                else if((CHdata4.AutoFlag==2)||(CHdata4.AutoFlag==4)) Reg3Data[25]=(ACC[3].risSW)? Rise : AUTO;
...
case 120: CHdata1.DataSet[RisTem]=dataBuff;CommIIC(&CHdata1.DataSet[RisTem],2,RisTem<<1,0);break;
case 121: CHdata2.DataSet[RisTem]=dataBuff;CommIIC(&CHdata2.DataSet[RisTem],2,64+(RisTem<<1),0);break;
case 122: CHdata3.DataSet[RisTem]=dataBuff;CommIIC(&CHdata3.DataSet[RisTem],2,128+(RisTem<<1),0);break;
case 123: CHdata4.DataSet[RisTem]=dataBuff;CommIIC(&CHdata4.DataSet[RisTem],2,192+(RisTem<<1),0);break;

case 124: ACC[0].risTime=CHdata1.DataSet[RisTime]=dataBuff;CommIIC(&CHdata1.DataSet[RisTime],2,RisTime<<1,0);break;
case 125: ACC[1].risTime=CHdata2.DataSet[RisTime]=dataBuff;CommIIC(&CHdata2.DataSet[RisTime],2,64+(RisTime<<1),0);break;
case 126: ACC[2].risTime=CHdata3.DataSet[RisTime]=dataBuff;CommIIC(&CHdata3.DataSet[RisTime],2,128+(RisTime<<1),0);break;
case 127: ACC[3].risTime=CHdata4.DataSet[RisTime]=dataBuff;CommIIC(&CHdata4.DataSet[RisTime],2,192+(RisTime<<1),0);break;

case 128: CHdata1.DataSet[RisRang]=dataBuff;CommIIC(&CHdata1.DataSet[RisRang],2,RisRang<<1,0);break;
case 129: CHdata2.DataSet[RisRang]=dataBuff;CommIIC(&CHdata2.DataSet[RisRang],2,64+(RisRang<<1),0);break;
case 130: CHdata3.DataSet[RisRang]=dataBuff;CommIIC(&CHdata3.DataSet[RisRang],2,128+(RisRang<<1),0);break;
case 131: CHdata4.DataSet[RisRang]=dataBuff;CommIIC(&CHdata4.DataSet[RisRang],2,192+(RisRang<<1),0);break;

case 132: Reg4Data[132] = ACC[0].risSW = dataBuff; break;
case 133: Reg4Data[133] = ACC[1].risSW = dataBuff; break;
case 134: Reg4Data[134] = ACC[2].risSW = dataBuff; break;
case 135: Reg4Data[135] = ACC[3].risSW = dataBuff; break;

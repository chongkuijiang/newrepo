...
#ifndef __IOSTM32F10xxE_H
#define __IOSTM32F10xxE_H
 ...
 ***************************************************************************
 **
 **   STM32F10xxE SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32_BIT(ADC3_SMPR2,        0x40013C10,__READ_WRITE ,__adc_smpr1_bits);
...
__IO_REG32_BIT(FSMC_BWTR1,        0xA0000104,__READ_WRITE ,__fsmc_btrx_bits );
__IO_REG32_BIT(FSMC_BWTR2,        0xA000010C,__READ_WRITE ,__fsmc_btrx_bits );
__IO_REG32_BIT(FSMC_BWTR3,        0xA0000114,__READ_WRITE ,__fsmc_btrx_bits );
__IO_REG32_BIT(FSMC_BWTR4,        0xA000011C,__READ_WRITE ,__fsmc_btrx_bits );
...
#define NVIC_TIM8_BRK         59          /* TIM8 Break interrupt         */
#define NVIC_TIM8_UP          60          /* TIM8 Update interrupt        */
#define NVIC_TIM8_TRG_COM     61          /* TIM8 Trigger and Commutation interrupts */
...
Interrupt51  = USBWakeup      0xE8
Interrupt52  = TIM8_BRK       0xEC
Interrupt53  = TIM8_UP        0xF0
Interrupt54  = TIM8_TRG_COM   0xF4
...
Interrupt65  = DMA2Ch1        0x120
Interrupt66  = DMA2Ch2        0x124
Interrupt67  = DMA2Ch3        0x128
Interrupt68  = DMA2Ch45       0x12C
